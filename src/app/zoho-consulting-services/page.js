          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div>
              ...
              <h1 style={{
                ...
                Expert Zoho
                <br />
                <span style={{ color: "var(--primary)" }}>Consulting Services</span>
              </h1>
              <p style={{
                ...
                From initial discovery through to optimisation, FI Digital's Zoho consulting services cover every stage of your Zoho journey.
              </p>
            ...
            <div style={{ position: "relative", borderRadius: "30px", overflow: "hidden", border: "1px solid var(--border)", boxShadow: "var(--card-shadow)" }}>
                <img src="/images1/saas/classic03.png" alt="Expert Zoho" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
          </div>
        </div>
      </section>
