          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div>
              ...
              <h1 style={{
                ...
                Zoho Consulting
                <br />
                <span style={{ color: "var(--primary)" }}>Partner UK</span>
              </h1>
              <p style={{
                ...
                FI Digital is a leading Zoho Consulting Partner in the UK. Our consultants deliver strategic advice and hands-on implementation across the Zoho ecosystem.
              </p>
            ...
            <div style={{ position: "relative", borderRadius: "30px", overflow: "hidden", border: "1px solid var(--border)", boxShadow: "var(--card-shadow)" }}>
                <img src="/images1/saas/classic01.png" alt="Zoho Consulting" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
          </div>
        </div>
      </section>
