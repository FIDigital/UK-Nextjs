          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div>
              ...
              <h1 style={{
                ...
                Your Zoho Partner
                <br />
                <span style={{ color: "var(--primary)" }}>in London</span>
              </h1>
              <p style={{
                ...
                FI Digital is headquartered in London, making us perfectly placed to serve London-based businesses with expert Zoho consulting and implementation.
              </p>
            ...
            <div style={{ position: "relative", borderRadius: "30px", overflow: "hidden", border: "1px solid var(--border)", boxShadow: "var(--card-shadow)" }}>
                <img src="/images1/saas/classic03.png" alt="Your Zoho Partner" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
          </div>
        </div>
      </section>
