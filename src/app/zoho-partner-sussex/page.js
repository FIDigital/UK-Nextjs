...
import { ArrowRight, ChevronDown, CheckCircle2, Shield, Users, Layers, Zap, Headphones, BarChart3, Repeat, Code, Settings, UserCheck, MapPin } from "lucide-react";

import { metadata as pageMetadata } from './meta';
export const metadata = pageMetadata;

const sussexServices = [
  {
    title: "Zoho CRM Consulting",
    content: "Transform your sales processes with Zoho CRM. Our certified consultants configure CRM modules, workflows, and automation rules to align with your sales cycle.",
    icon: <UserCheck size={24} />
  },
  {
    title: "Zoho One Rollout",
    content: "Zoho One is an all-in-one suite of 50+ integrated applications. We help Sussex businesses plan and implement Zoho One effectively across all departments.",
    icon: <Layers size={24} />
  },
  {
    title: "Zoho Creator App Development",
    content: "We design low-code applications using Zoho Creator to automate manual workflows and enhance organizational business efficiency.",
    icon: <Code size={24} />
  },
  {
    title: "Zoho Desk Implementation",
    content: "We configure and optimise Zoho Desk to improve ticket resolution and enhance customer satisfaction across your Sussex operations.",
    icon: <Headphones size={24} />
  },
  {
    title: "Zoho Analytics & BI",
    content: "Unlock business intelligence with Zoho Analytics. We implement dashboards, real-time reporting, and predictive models tailored to your KPIs.",
    icon: <BarChart3 size={24} />
  },
  {
    title: "Zoho Integration Services",
    content: "We connect Zoho with your ERP, accounting, telephony, and e-commerce platforms to ensure smooth, real-time data flow.",
    icon: <Repeat size={24} />
  }
];

const coverageAreas = [
  "Brighton & Hove", "Crawley", "Worthing", "Chichester", "Horsham", "Eastbourne", "Bognor Regis", "Haywards Heath", "Burgess Hill", "Hastings"
];

const faqs = [
  {
    q: "Why choose a local Zoho Partner in Sussex?",
    a: "A local partner like FI Digital understands your regional Sussex business landscape and regulatory expectations, ensuring a more personalised implementation."
  },
  {
    q: "How long does a Zoho implementation project take?",
    a: "Most projects range from 4 to 12 weeks, depending on the complexity of the departmental integrations and data volume."
  }
];

export default function ZohoPartnerSussexPage() {
  return (
      ...
      <section style={{
        ...
        <div className="hero-background-wrapper">
          <Image
            ...
            alt="Zoho Partner Sussex Background"
            fill
            style={{ 
              objectFit: "cover", 
          ...
          <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "4rem", alignItems: "center" }}>
            <div className="wow animate__animated animate__fadeIn hero-text-content">
              ...
              <h1 style={{
                ...
                Trusted Zoho <span style={{ color: "var(--primary)" }}>Partner in Sussex</span>
              </h1>
              <p style={{
                ...
                Searching for an experienced and reliable Zoho Partner in Sussex to help you implement and optimise Zoho’s powerful suite of business applications?
              </p>
              <p style={{
                fontSize: "clamp(1.1rem, 1.8vw, 1.35rem)",
                color: "var(--text-muted)",
                ...
                FI Digital is your trusted local partner, providing certified consulting and tactical implementation support to businesses across Sussex and the South Coast.
              </p>
        ...
        <div style={{ maxWidth: "1250px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "5rem", alignItems: "center" }}>
            <div style={{ position: "relative", borderRadius: "30px", overflow: "hidden", border: "1px solid var(--border)", boxShadow: "var(--card-shadow)" }} className="wow animate__animated animate__fadeInLeft">
                <Image src="/images1/Business2.jpg" alt="Sussex Regional Hub Advantage" width={600} height={400} style={{ width: "100%", height: "auto", objectFit: "cover" }} />
            </div>
            <div className="wow animate__animated animate__fadeInRight">
              <h2 style={{ fontSize: "clamp(1.8rem, 3.5vw, 2.5rem)", fontWeight: 850, color: "var(--text)", marginBottom: "1.5rem", lineHeight: 1.2 }}>
                The Sussex Local Edge
              </h2>
              <p style={{ color: "var(--text-muted)", fontSize: "1.1rem", lineHeight: 1.8, marginBottom: "1.5rem" }}>
                Effective digital transformation requires more than licensing—it requires tactical process alignment. We deliver personalised regional service and deep technical mastery.
              </p>
              <p style={{ color: "var(--text-muted)", fontSize: "1.1rem", lineHeight: 1.8, fontWeight: 700, marginBottom: "1.5rem" }}>
                Partnering with FI Digital ensures your South Coast enterprise receives the tactical depth required for rapid scale:
              </p>
              <ul style={{ display: "grid", gap: "1rem" }}>
                {[
                  "Certified Zoho Mastery with official South Coast backing.",
                  "Local Presence for real-time strategic onboarding and audits.",
                  "Deep sector expertise across Retail, Finance, and Healthcare.",
                  "Unified single-point-of-contact for all platform integrations.",
                  "GDPR focus ensuring your Sussex data handling is zero-risk."
                ].map((item, i) => (
        ...
        <div style={{ maxWidth: "1250px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "5rem" }}>
            <h2 style={{ fontSize: "clamp(2rem, 3.5vw, 3rem)", fontWeight: 850, color: "var(--text)", marginBottom: "1.5rem" }}>
              Our Sussex Partner Services
            </h2>
            <p style={{ color: "var(--text-muted)", fontSize: "1.15rem", maxWidth: "800px", margin: "0 auto" }}>
               Full suite of consulting and implementation services tailored for organizational excellence.
            </p>
          </div>
          <div className="feature-grid">
            {sussexServices.map((svc, i) => (
        ...
        <div style={{ maxWidth: "1250px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: "5rem", alignItems: "start" }}>
            ...
            <div style={{ background: "rgba(30, 58, 138, 1)", padding: "3.5rem", borderRadius: "40px", color: "white", boxShadow: "0 25px 50px -12px rgba(30, 58, 138, 0.4)" }} className="wow animate__animated animate__fadeInRight">
                <h3 style={{ fontSize: "2rem", fontWeight: 900, marginBottom: "2.5rem" }}>Sussex Success</h3>
                <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
                    {[
                        { label: "Brighton Retailer", val: "Integrated Zoho CRM & E-comm for seamless automated order cycles." },
                        { label: "Crawley Prof Hub", val: "Rolled out Zoho One suite reducing departmental silos by 40%." },
                        { label: "Worthing Healthcare", val: "Bespoke Creator patient management reducing admin overhead by 30%." }
                    ].map((stat, i) => (
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative" }}>
          <h2 style={{ 
            ...
            color: "white"
             ...
             Ready to Scale Your Sussex Business?
          </h2>
          <p style={{ 
            fontSize: "1.25rem", 
            ...
            margin: "0 auto 4rem" 
             ...
             Partner with FI Digital—your trusted, certified Zoho Partner in Sussex—and drive regional excellence today.
          </p>
