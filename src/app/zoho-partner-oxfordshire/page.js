          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div>
              ...
              <h1 style={{
                ...
                <br />
                <span style={{ color: "var(--primary)" }}>in Oxfordshire</span>
              </h1>
              <p style={{
                ...
                FI Digital supports Oxfordshire businesses with tailored Zoho implementations, from CRM to full Zoho One deployments.
              </p>
