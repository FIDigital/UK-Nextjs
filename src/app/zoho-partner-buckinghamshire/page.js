          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div>
              ...
              <h1 style={{
                ...
                <br />
                <span style={{ color: "var(--primary)" }}>in Buckinghamshire</span>
              </h1>
              <p style={{
                ...
                FI Digital works with businesses across Buckinghamshire to implement and optimise Zoho solutions tailored to local industries and requirements.
              </p>
