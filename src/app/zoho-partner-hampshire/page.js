          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div>
              ...
              <h1 style={{
                ...
                <br />
                <span style={{ color: "var(--primary)" }}>in Hampshire</span>
              </h1>
              <p style={{
                ...
                Hampshire businesses rely on FI Digital for expert Zoho implementation, training, and ongoing support from a certified UK partner.
              </p>
