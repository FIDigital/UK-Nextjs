...
const hampshireServices = [
  {
    title: "Zoho CRM Consulting",
    content: "Deploy and customise Zoho CRM to automate sales processes, lead management, and customer engagement strategies effectively.",
    icon: <Users size={24} />
  },
  {
    title: "Zoho One Rollout",
    content: "Complete business operating system with 50+ apps. We plan, configure, and implement for a smooth rollout across your company.",
    icon: <Layers size={24} />
  },
  {
    title: "Zoho Creator App Development",
    content: "Our certified developers build low-code custom apps to automate unique workflows and eliminate operational bottlenecks.",
    icon: <Code size={24} />
  },
  {
    title: "Zoho Desk Implementation",
    content: "Enhance customer support by configuring and optimising Zoho Desk to streamline ticket management and satisfaction.",
    icon: <Headphones size={24} />
  },
  {
    title: "Zoho Analytics & BI",
    content: "Turn data into insights with dashboards, advanced reporting, and predictive analytics tailored to your strategic goals.",
    icon: <BarChart3 size={24} />
  },
  {
    title: "Zoho Integration Services",
    content: "Integrate Zoho with your ERP, accounting, telephony, and e-commerce platforms for seamless, real-time data flow.",
    icon: <Repeat size={24} />
  }
];

const coverageAreas = [
  "Southampton", "Portsmouth", "Basingstoke", "Winchester", "Andover",
  "Eastleigh", "Aldershot", "Fareham", "Gosport", "Havant"
];

const faqs = [
  {
    q: "Why choose a local Zoho Partner in Hampshire?",
    a: "A local partner like FI Digital understands the regional Hampshire business environment and customer expectations, ensuring a personalised implementation."
  },
  {
    q: "How long does a Zoho implementation project take?",
    a: "Typical projects range from 4 to 12 weeks, depending on complexity, data volume, and specific business requirements."
  }
];

export default function ZohoPartnerHampshirePage() {
  return (
      ...
      <section style={{
        ...
        <div className="hero-background-wrapper">
          <Image
            ...
            alt="Zoho Partner Hampshire Background"
            fill
            style={{ 
              objectFit: "cover", 
          ...
          <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "4rem", alignItems: "center" }}>
            <div className="wow animate__animated animate__fadeIn hero-text-content">
              ...
              <h1 style={{
                ...
                Trusted Zoho <span style={{ color: "var(--primary)" }}>Partner in Hampshire</span>
              </h1>
              <p style={{
                ...
                Looking for a reliable, certified, and experienced Zoho Partner in Hampshire to help streamline and digitise your business operations?
              </p>
              <p style={{
                fontSize: "clamp(1.1rem, 1.8vw, 1.35rem)",
                color: "var(--text-muted)",
                ...
                FI Digital provides end-to-end consulting, tactical implementation, and ongoing support for businesses across Southampton, Portsmouth, and Winchester.
              </p>
        ...
        <div style={{ maxWidth: "1250px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "5rem", alignItems: "center" }}>
            <div style={{ position: "relative", borderRadius: "30px", overflow: "hidden", border: "1px solid var(--border)", boxShadow: "var(--card-shadow)" }} className="wow animate__animated animate__fadeInLeft">
                <Image src="/images1/Business1.jpg" alt="Local Hampshire Advantage" width={600} height={400} style={{ width: "100%", height: "auto", objectFit: "cover" }} />
            </div>
            <div className="wow animate__animated animate__fadeInRight">
              <h2 style={{ fontSize: "clamp(1.8rem, 3.5vw, 2.5rem)", fontWeight: 850, color: "var(--text)", marginBottom: "1.5rem", lineHeight: 1.2 }}>
                The Hampshire Local Edge
              </h2>
              <p style={{ color: "var(--text-muted)", fontSize: "1.1rem", lineHeight: 1.8, marginBottom: "1.5rem" }}>
                By working with FI Digital, you benefit from a local South Coast team that understands your regional market dynamics and operational requirements.
              </p>
              <p style={{ color: "var(--text-muted)", fontSize: "1.1rem", lineHeight: 1.8, fontWeight: 700, marginBottom: "1.5rem" }}>
                We provide the tactical proximity needed for complex South Coast digital transformations:
              </p>
              <ul style={{ display: "grid", gap: "1rem" }}>
                {[
                  ...
                  "Deep sector expertise across Finance, Retail, and Healthcare.",
                  "Unified single-point-of-contact for all platform integrations.",
                  "GDPR focus ensuring your South Coast data handling is zero-risk."
                ].map((item, i) => (
        ...
        <div style={{ maxWidth: "1250px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "5rem" }}>
            ...
            <p style={{ color: "var(--text-muted)", fontSize: "1.15rem", maxWidth: "800px", margin: "0 auto" }}>
              A full range of Zoho consulting and implementation services tailored for organizational excellence.
            </p>
          </div>
          <div className="feature-grid">
            {hampshireServices.map((svc, i) => (
        ...
        <div style={{ maxWidth: "1250px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: "5rem", alignItems: "start" }}>
            ...
            <div style={{ background: "rgba(30, 58, 138, 1)", padding: "3.5rem", borderRadius: "40px", color: "white", boxShadow: "0 25px 50px -12px rgba(30, 58, 138, 0.4)" }} className="wow animate__animated animate__fadeInRight">
                <h3 style={{ fontSize: "2rem", fontWeight: 900, marginBottom: "2.5rem" }}>Hampshire Success</h3>
                <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
                    {[
                        { label: "Southampton Retail", val: "Implemented Zoho CRM & Analytics for 360° visibility of customer cycles." },
                        { label: "Winchester Prof Hub", val: "Unified sales/finance silo's reducing operational overhead by 30%." },
                        { label: "Basingstoke Health", val: "Custom patient management on Zoho Creator with full compliance." }
                    ].map((stat, i) => (
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative" }}>
          <h2 style={{ 
            ...
            color: "white"
             ...
             Ready to Scale Your Hampshire Business?
          </h2>
          <p style={{ 
            fontSize: "1.25rem", 
            ...
            margin: "0 auto 4rem" 
             ...
             Partner with FI Digital—your trusted, certified Zoho Partner in Hampshire—and drive business growth today.
          </p>
