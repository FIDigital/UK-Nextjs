          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div>
              ...
              <h1 style={{
                ...
                Work With a
                <br />
                <span style={{ color: "var(--primary)" }}>Certified Zoho Consultant</span>
              </h1>
              <p style={{
                ...
                FI Digital's certified Zoho consultants have passed rigorous examinations, ensuring expert-level guidance for your business.
              </p>
            ...
            <div style={{ position: "relative", borderRadius: "30px", overflow: "hidden", border: "1px solid var(--border)", boxShadow: "var(--card-shadow)" }}>
                <img src="/images1/saas/classic03.png" alt="Work With a" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
          </div>
        </div>
      </section>
