          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div>
              ...
              <h1 style={{
                ...
                <br />
                <span style={{ color: "var(--primary)" }}>in Surrey</span>
              </h1>
              <p style={{
                ...
                Surrey businesses partner with FI Digital for expert Zoho CRM, Zoho One, and custom application development to drive growth and efficiency.
              </p>
