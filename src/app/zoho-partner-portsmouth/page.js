          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "4rem", alignItems: "center" }}>
            <div>
              ...
              <h1 style={{
                ...
                <br />
                <span style={{ color: "var(--primary)" }}>in Portsmouth</span>
              </h1>
              <p style={{
                ...
                FI Digital helps Portsmouth businesses streamline operations with expert Zoho consulting, implementation, and ongoing managed services.
              </p>
